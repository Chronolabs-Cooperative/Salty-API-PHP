...
<head>
<meta property="og:title" content="Blowfish Salts Repository API"/>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Blowfish Salts Repository API || <?php echo $business; ?></title>
...
<div class="main">
    ...
    <?php } ?>
    <h1>Blowfish Salts Repository API Services -- <?php echo $business; ?></h1>
    ...
    <?php if (file_exists(sprintf(API_FILE_IO_FOOTER, getBaseDomain('http://'.$_SERVER['HTTP_HOST'])))) {
    	readfile(sprintf(API_FILE_IO_FOOTER, getBaseDomain('http://'.$_SERVER['HTTP_HOST'])));
    }?>	
